...
import { Send, Square, Trash2, X, ChevronDown, Bot } from 'lucide-react'
          ...
          <>
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: renderChat(msg.content) || '<span class="opacity-40">…</span>',
              }}
            />
            {msg.streaming && (
    ...
    <>
        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-2.5 px-4 py-3 border-b border-slate-100 dark:border-slate-700 shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-slate-400 mt-0.5">DeepSeek · TaskPro</p>
            </div>
            ...
            {messages.length === 0 && showTip && (
              <div className="py-4 space-y-3">
                <div className="text-center">
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">Hỏi về tasks, ghi chú, deadline hoặc dự án của bạn</p>
                </div>
            ...
            <div className="flex items-end gap-2 bg-slate-50 dark:bg-slate-700/60 rounded-xl border border-slate-200 dark:border-slate-600 px-3 py-2">
              ...
              {loading ? (
                <button onClick={stop} title="Dừng"
                  className="shrink-0 p-1.5 rounded-lg bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 hover:bg-red-200 transition-colors">
      ...
      <button
        ...
        className={cn(
          ...
          open
            ? 'bg-slate-700 dark:bg-slate-600 hover:bg-slate-800 scale-95'
            : 'bg-gradient-to-br from-blue-500 to-indigo-600 hover:shadow-blue-500/40 hover:shadow-2xl hover:scale-105',
        )}
      >
        {open
