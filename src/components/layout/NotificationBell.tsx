    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="fixed right-4 z-40 w-80 max-w-[calc(100vw-2rem)] bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-2xl overflow-hidden pop-in"
