...
export const en: Translations = {
  ...
  views: { dashboard: 'Dashboard', kanban: 'Kanban', list: 'List', calendar: 'Calendar', timeline: 'Timeline', notes: 'Notes', habits: 'Habits' },
  ...
  habits: {
    ...
    emptyDesc: 'Start building positive daily habits and track your streaks.',
    addFirst: 'Create first habit',
    addHabit: 'Add habit',
    editHabit: 'Edit habit',
    name: 'Habit name',
    namePlaceholder: 'e.g. Exercise 30 minutes…',
    ...
    allDone: 'Amazing! All habits done today 🎉',
